...
import { Search, Filter, ArrowUpDown, Play, Eye, ClipboardList, FileText } from 'lucide-react';
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', gap: '16px', flexGrow: 1, maxWidth: '600px' }}>
          ...
          <div style={{ position: 'relative', flexGrow: 1 }}>
            ...
            <input
              type="text"
              placeholder="Search by report title or stock symbol..."
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: '160px' }}>
            ...
            >
              ...
              <option value="initiated">Researching...</option>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border-glass)' }}>
                  <th style={{ padding: '12px 16px', color: 'var(--text-bright)', fontSize: '13px', fontWeight: 600 }}>Report Title</th>
                  <th style={{ padding: '12px 16px', color: 'var(--text-bright)', fontSize: '13px', fontWeight: 600 }}>Companies</th>
                  <th style={{ padding: '12px 16px', color: 'var(--text-bright)', fontSize: '13px', fontWeight: 600 }}>Date Created</th>
